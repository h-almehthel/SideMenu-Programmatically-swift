...
class GreenVC: UIViewController {
    ...
    let titleLable : UILabel = {
        ...
        $0.textColor = #colorLiteral(red: 0, green: 0.5603182912, blue: 0, alpha: 1)
    ...
    let image : UIImageView = {
        ...
        $0.image = #imageLiteral(resourceName: "Green")
        $0.tintColor = #colorLiteral(red: 0, green: 0.5628422499, blue: 0.3188166618, alpha: 1)
        return $0
    }(UIImageView())
